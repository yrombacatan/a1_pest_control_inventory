...
class ProductCategoryController extends AppBaseController
{
    ...
    {
        $this->middleware('permission:product-cat-list|product-cat-create|product-cat-edit|product-cat-delete', ['only' => ['index','show']]);
        $this->middleware('permission:product-cat-create', ['only' => ['create','store']]);
        $this->middleware('permission:product-cat-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:product-cat-delete', ['only' => ['destroy']]);
