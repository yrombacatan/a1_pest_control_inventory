          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">Add new order to the system. </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                ...
                @include('adminlte-templates::common.errors')
                    ...
                    {!! Form::open(['route' => 'orders.store', 'class' => '', 'id' => 'ordersForm']) !!}
