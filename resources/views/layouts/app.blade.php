...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{secure_asset('adminlte/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
  <!-- iCheck -->
...
<!-- SweetAlert2 -->
<script src="{{secure_asset('adminlte/plugins/sweetalert2/sweetalert2.min.js')}}"></script>
<!-- DataTables -->
...
<!-- jquery-validation -->
<script src="{{secure_asset('adminlte/plugins/jquery-validation/jquery.validate.min.js')}}"></script>
<script src="{{secure_asset('adminlte/plugins/jquery-validation/additional-methods.min.js')}}"></script>
<!-- AdminLTE App -->
